    ...
    if (empty($errors)) {
        ...
        if ($id > 0) {
            ...
            if ($idUsuario > 0) {
                ...
                $asunto = "Activar cuenta - AKÁ Mercado";
                $cuerpo = "Estimado $nombres: <br> Para continuar con el proceso de registro de click en el siguiente link <a href='$url'>Activar cuenta</a>";
