...
// Mostrar el producto con sus detalles
            ...
            <div class="row">
                ...
                <div class="col-md-7 order-md-2">
                    ...
                    <div class="d-grid gap-3 col-7">
                        <button class="btn btn-warning" type="button" onClick="comprarAhora(<?php echo $id; ?>, cantidad.value)">Comprar ahora</button>
                        <button class="btn btn-outline-dark" type="button" onClick="addProducto(<?php echo $id; ?>, cantidad.value)">Agregar al carrito</button>
                    </div>
                </div>
            </div>
        </div>
