...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: red;">
        ...
        <img src="<?php echo SITE_URL; ?>images/logoakamarket.png" alt="Logo" style="height: 40px;">
            <a class="navbar-brand" href="index.php"><strong>AKÁ Mercado</strong></a>
            ...
            <div class="collapse navbar-collapse" id="navBarTop">
                ...
                <a href="checkout.php" class="btn btn-warning me-2">
                    <i class="fas fa-shopping-cart"></i> Carrito <span id="num_cart" class="badge bg-secondary"><?php echo $num_cart; ?></span>
                </a>
                <?php if (isset($_SESSION['user_id'])) { ?>
                    <div class="dropdown">
                        <button class="btn btn-dark dropdown-toggle" type="button" id="btn_session" data-bs-toggle="dropdown" aria-expanded="false">
