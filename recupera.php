    ...
    if (empty($errors)) {
        if (emailExiste($email, $con)) {
            ...
            if ($token !== null) {
                ...
                $asunto = "Recuperar password - AKÁ Mercado";
                $cuerpo = "Estimado $nombres: <br> Si ha solicitado el cambio de su contraseña, de click en el siguiente link: <a href='$url'>$url</a>.";
